        ...
        <>
            ...
            <Container maxWidth="md">
                <Box display="flex" justifyContent="center" alignItems="center" marginTop={2} marginBottom={3}>
                    <Typography variant="h3" color="secondary">Datos de usuario</Typography>
                </Box>
                <Paper elevation={5}>
                    <Box padding={4}>
                        <Grid container spacing={2}>
                            ...
                            <Grid className={classes.root} display="flex" alignItems="center" item xs>
                                ...
                                <Input defaultValue="Apellido Paterno" disabled inputProps={{ 'aria-label': 'description' }} />
                                <Input defaultValue="Apellido Materno" disabled inputProps={{ 'aria-label': 'description' }} />

                                <Input defaultValue="Correo" disabled inputProps={{ 'aria-label': 'description' }} />
                                <Input defaultValue="No. de contacto" disabled inputProps={{ 'aria-label': 'description' }} />
